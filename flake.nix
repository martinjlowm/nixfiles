{
  inputs = {
    ...
    nextNixpkgs.url = "github:NixOS/nixpkgs/e99366c665bdd53b7b500ccdc5226675cfc51f45";
    ...
    userConfiguration = nix-darwin.lib.darwinSystem {
      ...
      modules = [
        ...
        home-manager.darwinModules.home-manager
        {
          ...
          home-manager.users.martinjlowm = {
            pkgs,
            nextPkgs,
            lib,
            config,
          ...
          in {
            ...
            home.file = {
              ".config/emacs/.local/cache/tree-sitter".source = "${allGrammars}/lib";
              ".config/sketchybar" = {
                source = ./sketchybar;
                recursive = true;
              };
